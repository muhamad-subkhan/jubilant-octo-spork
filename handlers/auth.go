...
func (h *handlerAuth) Register(w http.ResponseWriter, r *http.Request) {
	...
	response := dto.SuccessResult{Code: http.StatusOK, Data: convertResponseAuth(data), Status: "Success"}
	json.NewEncoder(w).Encode(response)
}
...
func (h *handlerAuth) Login(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Type", "application/json")
	response := dto.SuccessResult{Code: http.StatusOK, Data: loginResponse, Status: "Success"}
	json.NewEncoder(w).Encode(response)
...
func (h *handlerAuth) CheckAuth(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Type", "application/json")
	response := dto.SuccessResult{Code: http.StatusOK, Data: CheckAuthResponse, Status: "Success"}
	json.NewEncoder(w).Encode(response)
}
